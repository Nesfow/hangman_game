...
HANGMAN_PICS = ['''
 ...
 / \  |
     ===''']
words = {'Цвета': 'красный оранжевый зелёный синий голубой фиолетовый черный коричневый'.split(),
         'Фигуры': 'квадрат треугольник прямоугольник круг эллипс ромб трапеция параллелограмм пятиугольник шестиугольник '
         ...
         'Животные': 'аист бабуин баран барсук бык волк зебра кит коза корова кошка кролик крыса лев лисо лось лосось медведь '
